...
// с 22 по 38 строку код , с помощью которого мы делаем задрежку на 2 секунды после нажатия на кнопку открыть магазиг
function start() {
...
// **** повторения скрипта через определнённое кол-во времени
// **** setInterval ****
// например повторении анимации , обращение к серверу 
/*
let timerid = setInterval(func, delay)
*/
// рекурсивный метод - метод когда функция вызывает саму себя
// *** фунция вызывает саму себя через определнный промежуток времени
